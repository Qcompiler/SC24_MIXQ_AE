...
# fp16 =  np.array([1464.9072056929558, 2979.338904982297, 4777.1966329127445, 6608.57736171889, 7433.2856168722155])
# bnb =  np.array( [243.25558399002458, 473.0694539536351, 946.8923387338575, 1818.3019073052687, 3322.93297372658] )  

# mixq8 = np.array([1477.0951511016222, 3007.7812811635126, 5366.696608771711, 8798.674342091785, 10973.036772088673] ) 
# EETQ = np.array([1658.8894, 2210.129776, 3350.20729297, 5681.27497242, 5888.09020148]) 
# # fp16 = fp16/ fp16
...
# # ax2
# awq =  np.array([2331.8894670546842, 2930.182195272376, 3250.207572927797, 3481.27497175242, 3588.091702130148] )
# fp16 = np.array([1464.9072056929558, 2979.338904982297, 4777.1966329127445, 6608.57736171889, 7433.2856168722155] )
# mixq4 = np.array([1247.1158726102813, 2516.6217222144096, 4946.523351914129, 9013.459003664173, 11537.423162057035] )
# quik = np.array([1147.1158726102813, 2116.6217222144096, 4311.523351914129, 7813.459003664173, 9100.423162057035] )
...
rects1 = ax1.bar(x - width*2, fp16, width, label='FP 16', color=bar_colors_default[0])
#rects2 = ax1.bar(x - width+0.01, bnb, width, label='Bitsandbytes', color=bar_colors_default[3])
rects3 = ax1.bar(x + 0.02, EETQ, width, label='8bit Weight Only', color=bar_colors_default[2])
#rects4 = ax1.bar(x + width+0.03, mixq8, width, label='MixQ', color = bar_colors_default[1])
#autolabel(rects4, ax1)
autolabel(rects1, ax1)
ax1.set_xticks(x)
...
rects1 = ax2.bar(x - width*2, fp16, width, color=bar_colors_default[0])
rects2 = ax2.bar(x - width+0.01, awq, width, label='4bit Weight Only', color=bar_colors_default[4])
#rects4 = ax2.bar(x + 0.02, quik, width, color=bar_colors_default[1])
#rects3 = ax2.bar(x + width + 0.02, mixq4, width, color=bar_colors_default[1])
...
# Set the x-axis and y-axis labels for ax1
ax1.set_xlabel('Batch Size',fontsize=12,fontdict={'family' : 'Times New Roman', 'size' : 16})
ax1.set_ylabel('吞吐 （Token/s）',fontsize=12,fontdict={'family' : 'Times New Roman', 'size' : 16})
ax1.set_title('LLaMA-70B, 8-bit Quantization',fontsize=12, fontname='Times New Roman')

# Set the x-axis and y-axis labels for ax2
ax2.set_xlabel('Batch Size',fontsize=12, fontproperties = 'Times New Roman')
#ax2.set_ylabel('吞吐（Token/s）',fontsize=12, fontproperties = 'Times New Roman')
